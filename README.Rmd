...
The goal of PROJ is to provide generic coordinate system transformations in R with a functional requirement for the system library to be provided by the [libproj package](https://cran.r-project.org/package=libroj). 
...
PROJ is strictly for modern versions of the PROJ library, now via [libproj package](https://cran.r-project.org/package=libroj) at version 7. Alternative pathways to 
