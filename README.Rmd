...
Note that for PROJ5 (and lower) this package is non-functional (can use proj4). The testing here on Travis ensures that the package installs successfully for various versions of PROJ, although underlying functionality is disabled for 4 and 5. 

[![Travis PROJ5](https://img.shields.io/travis/hypertidy/PROJ.svg?branch=master&env=BUILD_NAME=proj5&label=PROJ5)](https://travis-ci.org/hypertidy/PROJ)
<br>
...
The goal of PROJ is to provide generic coordinate system transformations in R.  This is same goal as the [reproj](https://cran.r-project.org/package=reproj)  package, but provided for later versions of the underlying library. 
...
* Why not mapproject? This is unusable for real-world projections in my experience, it seems
to be written for some basic graphics cases.
