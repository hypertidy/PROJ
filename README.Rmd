...
functional requirement is for the system library PROJ >= 6. This is same goal as the [reproj](https://cran.r-project.org/package=reproj)  package, but provided for later versions of the underlying library. Reproj currently uses PROJ 5 or 6 via the proj4 package, 
