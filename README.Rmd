...
The equirectangular projection or equidistant cylindrical projection is "plane chart" or plate carrée projection. The simplest of all map projections, this is just the longlat projection rescaled from radians to the radius of the earth. 
