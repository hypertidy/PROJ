...
We don't enter into the coordinate order debacle of the [OGC](https://en.wikipedia.org/wiki/Open_Geospatial_Consortium/) for longitude, latitude. Projection strings are able
