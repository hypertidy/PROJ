...
We enter into the coordinate order debacle of the [OGC](https://www.opengeospatial.org/) for longitude, latitude by precluding
...
#> crs to crs problem
#> Error in proj_trans_generic(cbind(c(0, 147), c(0, -42)), z_ = 0, target = "+proj=laea +datum=WGS84", : problem in PROJ transformation
```
